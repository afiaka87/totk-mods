...
public:
    ...
    // Mask only owned bits in this frame's fresh samples.
    ...
    // Substitute only owned axes in this frame's fresh samples.
    ...
    // Substitute only owned camera axes in this frame's fresh samples.
    ...
    // Add an owned edge for an explicit player action, only in fresh samples.
